...
SYSTEM_PROMPT_ENHANCED = (
    ...
    "3. Never use h1 tags in the description, only use h2 or h3 for headings.\n"
    "4. If description does not contain any markup, add appropriate HTML.\n"
    "5. If the description is blank, create an appropriate one using the information available from the title.\n"
    "6. If the description contains the product title, remove it from the description.\n"
    "7. If the description contains the string:'So grab this and place your orders now', in any case or form, remove it.\n\n"
    "**Output JSON Format:**\n"
    "```json\n"
    "{ \n"
    '  "rephrased_title": "...",\n'
